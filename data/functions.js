...
//	checkbox: name identifier for the Aramex's Special checkbox element
// ---------------------------------
function toggleAramexSpecial(checkbox) {
	var enabled = !!(checkbox && checkbox.checked);
	settings.aramex_special = enabled ? 1 : 0;
...
function setCharacterInfo(className) {
	...
	if (typeof fileInfo.settings.aramex_special !== 'undefined' && settings.aramex_special != ~~fileInfo.settings.aramex_special) {
